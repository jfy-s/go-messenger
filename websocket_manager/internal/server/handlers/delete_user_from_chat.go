...
func HandleDeleteUserFromChat(storage storage.Storage, msgPacketRequest *model.MessagePacketRequest, logger *slog.Logger) *model.MessagePacketRequest {
	...
	if err != nil {
		...
		return &model.MessagePacketRequest{MsgType: model.DeleteUserFromChat, From: 0, To: msgPacketRequest.From, Data: "Internal Error"}
	}
	...
	return &model.MessagePacketRequest{MsgType: model.DeleteUserFromChat, From: 0, To: msgPacketRequest.From, Data: "Success"}
}
