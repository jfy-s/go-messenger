...
func HandleGetLlUsersIDInChat(storage storage.Storage, msgPacketRequest *model.MessagePacketRequest, logger *slog.Logger) *model.MessagePacketRequest {
	...
	if err := validator.Struct(req); err != nil {
		...
		return &model.MessagePacketRequest{MsgType: model.GetAllUsersIDInChat, From: 0, To: msgPacketRequest.From, Data: "Internal Error"}
	}
	...
	return &model.MessagePacketRequest{MsgType: model.GetAllUsersIDInChat, From: 0, To: msgPacketRequest.From, Data: "Success"}
}
